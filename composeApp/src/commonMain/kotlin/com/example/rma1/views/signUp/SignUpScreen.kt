...
private fun MainScreen(
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            onValueChange = {
                username = it
                eventPublisher(SignUpContract.UiEvent.UsernameUpdate)
            },
        ...
        OutlinedTextField(
            ...
            onValueChange = {
                fullName = it
                eventPublisher(SignUpContract.UiEvent.FullNameUpdate)
            },
            modifier = Modifier.fillMaxWidth(),
        ...
        OutlinedTextField(
            ...
            onValueChange = {
                password = it
                eventPublisher(SignUpContract.UiEvent.PasswordUpdate)
            },
            modifier = Modifier.fillMaxWidth(),
            label = { Text("Password") },
            singleLine = true,
        ...
        val canSignUp = username.isNotBlank() &&
                password.isNotBlank() &&
                fullName.isNotBlank() &&
